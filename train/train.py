...
if __name__ == "__main__":
    sys.exit(main())
                ...
                #     if is_main_process:
                #         logger.info(
                #             f"Validation loss improved from {best_val_metric:.4f} to {val_loss:.4f}"
                #         )
                ...
                #     if is_main_process:
                #         logger.info(
                #             f"No improvement in validation loss for {no_improvement_count} evaluation(s)"
                #         )
                
                # Early stopping
                # if args.early_stopping_patience > 0 and no_improvement_count >= args.early_stopping_patience:
                #     if is_main_process:
                #         logger.info(
                #             f"Early stopping triggered after {no_improvement_count} evaluations "
