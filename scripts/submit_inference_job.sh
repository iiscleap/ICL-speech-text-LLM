...
debug_samples=500  # Add debug_samples parameter (0 = use all samples)
...
peft_model_path="/data2/neeraja/neeraja/results/model_ICL/trained_models/1503_0227_ft_5ex_20e8b_salmonn_speech_only_text_voxceleb-hvb/checkpoints/epoch_2_loss_0.1537/model.pt"
# peft_model_path="/data2/neeraja/neeraja/results/model_ICL/trained_models/1803_1820_ft_5ex_10e8b_salmonn_speech_only_text_voxceleb/checkpoints/epoch_4_loss_0.1016/model.pt"
