...
dataset_type="voxpopuli,hvb,voxceleb"  # Options: "voxceleb", "hvb", "voxpopuli", etc., sqa, vp_nel
...
hold_job_id="136100"          # Job ID to wait for (empty = don't wait)
...
# peft_model_path="/data2/neeraja/neeraja/results/model_ICL/trained_models/2303_0105_ft_5ex_10e8b_salmonn_speech_only_text_voxceleb-hvb/final_model.pt"
