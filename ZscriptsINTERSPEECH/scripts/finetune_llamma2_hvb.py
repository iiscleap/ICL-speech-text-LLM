...
class SentimentDataset(Dataset):
    def __init__(self, dataset, tokenizer):
        ...
        for item in self.dataset:
            ...
            labels = item['dialog_acts']  # This is now a list
            for label in labels:
        ...
        # Log both raw counts and percentages
    ...
    def _create_prompt(self, item):
        text = item['text']
        dialog_actions = item['dialog_acts']  # This is a list
        # Convert list to comma-separated string for completion
        dialog_actions_text = ", ".join(dialog_actions)
...
Output: """
        ...
        return {"prompt": prompt, "completion": f"{dialog_actions_text}</s>"}
...
def main():
    ...
    dataset = load_from_disk("/data2/neeraja/neeraja/data/asapp/slue-phase-2_hvb_train_10fewshots")
