...
class TrainingDataset(BaseMultiTaskDataset):
    ...
    def __init__(
        ...
        Args:
            ...
            random_examples: Whether to randomly select few-shot examples (default True for training)
            model_type: Type of model ('salmonn', 'qwen2', etc.)
        """
        # Always use TRAIN split for training dataset
        super().__init__(
    ...
    def _is_training(self):
        """Override to indicate this is a training dataset"""
        return True
